...
<?php echo $this->Form->input('area', array('options' => array(), 'empty' => '--Select--')); ?>                       
        ...
        <?php
            ...
            <div class="form-group">
                ...
                <label><?php echo $values['LookupQuestion']['question']; ?></label>          
                <span class="colon">:</span>         
    <?php
        ...
        <?php
    } elseif ($values['LookupQuestion']['id'] == '53') {
        ?>


        <div class="col-sm-10" style="padding-top:6px;">
        <?php echo $this->Form->input('response1', array('label' => false, 'div' => false, 'type' => 'text', 'placeholder' => 'Type the WTB Hotel Id here', 'data-required' => 'false')); ?>            
        </div>           
        <?php   
    } elseif ($values['LookupQuestion']['id'] == '59') {
        ?>


        <div class="col-sm-10" style="padding-top:6px;">
        <?php echo $this->Form->input('response2', array('label' => false, 'div' => false, 'type' => 'text', 'placeholder' => 'Type the Existing Supplier Hotel Id here')); ?>            
        </div>           
        <?php             
        ...
        <div class="col-sm-10" style="padding-top:6px;">
        <?php echo $this->Form->input('response1', array('label' => false, 'div' => false, 'type' => 'text', 'placeholder' => 'Type the Existing Supplier Hotel Id here')); ?>            
        </div>           
        <?php           
    }
    ?>
