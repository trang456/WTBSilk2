...
<div class="col-sm-12" id="mycl-det">
    <div class="panel panel-default">
        ...
        <div class="col-sm-12" style="background-color: rgb(100, 233, 300);overflow:hidden;">
                <h4>Mapping Supplier [<?php echo $SupplierHotels['SupplierHotel']['supplier_code'];?>] Hotel: [<?php echo $SupplierHotels['SupplierHotel']['hotel_name'];?>]</h4>
        </div>        
                
                <div class="col-sm-6" style="margin-top:10px">
                    <div class="form-group">
                            <label for="reg_input_name">Supp. Hotel Id</label>
                            <span class="colon">:</span>
                            <div class="col-sm-10">
                                <?php echo $SupplierHotels['SupplierHotel']['id'] ?></div>
                        </div>
                    <div class="form-group">
                ...
                <div class="col-sm-6" style="margin-top:10px">
                    <div class="form-group">
                            ...
                            <span class="colon">:</span>
                            <div class="col-sm-10">
                                <?php echo $SupplierHotels['SupplierHotel']['hotel_code'] ?></div>
                        </div>
                    <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <?php
//                                echo $HotelUrl['TravelHotelLookup']['country_name'];                        
//                        echo $this->Form->input('TravelHotelRoomSupplier.hotel_country_code', array('country_code' => 'hotel_country_code', 'options' => $TravelCountries, 'value' => $TravelHotelRoomSuppliers['TravelHotelRoomSupplier']['hotel_country_code'], 'empty' => '--Select--', 'disabled' => true));
                        ...
                        ?></div>
                         ...
                         <div class="form-group">
                            <label for="reg_input_name" style="margin-left:15px;">Supp. Hotel Address</label>
                            <span class="colon">:</span>
                            <div class="col-sm-10" id="MappingWebsiteUrl">
                                <?php echo $SupplierHotels['SupplierHotel']['address'] ?>
                            </div>
                        </div>              
            ...
            <div class="clear" style="clear: both;"></div>
                    <div class="col-sm-12" style="background-color: rgb(211, 233, 237);overflow:hidden;">
                        <h4>Chosen WTB Hotel: [<?php echo $TravelHotelRoomSuppliers['TravelHotelRoomSupplier']['hotel_name'];?>]</h4>
            </div>                        
                <div class="col-sm-6" style="margin-top:10px">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <?php
                                echo $this->Form->input('TravelHotelRoomSupplier.hotel_suburb_id', array('options' => $TravelSuburbs, 'value' => $TravelHotelRoomSuppliers['TravelHotelRoomSupplier']['hotel_suburb_id'], 'empty' => '--Select--', 'disabled' => true));
                                ?></div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <?php
                                echo $this->Form->input('TravelHotelRoomSupplier.hotel_chain_id', array('options' => $TravelChains, 'value' => $TravelHotelRoomSuppliers['TravelHotelRoomSupplier']['hotel_chain_id'], 'empty' => '--Select--', 'disabled' => true));
                                ?></div>
                        </div>
                </div>
                <div class="col-sm-6" style="margin-top:10px">
...
//                                echo $HotelUrl['TravelHotelLookup']['country_name'];                        
//                        echo $this->Form->input('TravelHotelRoomSupplier.hotel_country_code', array('country_code' => 'hotel_country_code', 'options' => $TravelCountries, 'value' => $TravelHotelRoomSuppliers['TravelHotelRoomSupplier']['hotel_country_code'], 'empty' => '--Select--', 'disabled' => true));
                        echo $this->Form->input('TravelHotelRoomSupplier.hotel_country_id', array('id' => 'hotel_country_id', 'options' => $TravelCountries, 'value' => $TravelHotelRoomSuppliers['TravelHotelRoomSupplier']['hotel_country_id'], 'empty' => '--Select--', 'disabled' => true));                        
                        ?></div>
                </div>
                <div class="form-group">
                    <label for="reg_input_name">WTB City</label>
                    ...
                    <div class="col-sm-10">
                        <?php
//                                echo $HotelUrl['TravelHotelLookup']['city_name'];                        
                        echo $this->Form->input('TravelHotelRoomSupplier.hotel_city_id', array('id' => 'hotel_city_id', 'options' => $TravelCities, 'value' => $TravelHotelRoomSuppliers['TravelHotelRoomSupplier']['hotel_city_id'], 'empty' => '--Select--', 'disabled' => true));
                        ?></div>
                </div>
                      <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <?php
                                echo $this->Form->input('TravelHotelRoomSupplier.hotel_area_id', array('options' => $TravelAreas, 'value' => $TravelHotelRoomSuppliers['TravelHotelRoomSupplier']['hotel_area_id'], 'empty' => '--Select--', 'disabled' => true));
                                ?></div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <?php
                                echo $this->Form->input('TravelHotelRoomSupplier.hotel_brand_id', array('options' => $TravelBrands, 'value' => $TravelHotelRoomSuppliers['TravelHotelRoomSupplier']['hotel_brand_id'], 'empty' => '--Select--', 'disabled' => true));
                                ?></div>
                        </div>
                </div>
                        <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="reg_input_name" style="margin-left:16px;">WTB City [<?php echo $TravelHotelRoomSuppliers['TravelHotelRoomSupplier']['hotel_city_name'];?>]</label>
                            <span class="colon">:</span>
                            <div class="col-sm-10">
                                <?php
                               echo $this->Html->link('Click here to view mappings for this WTB City.', '/travel_hotel_lookups/view_city_mapping/'.$SupplierHotels['SupplierHotel']['supplier_id'].'/'.$TravelHotelRoomSuppliers['TravelHotelRoomSupplier']['hotel_city_id'], array('class' => 'act-ico open-popup-link add-btn', 'escape' => false));
                                ?></div>
                        </div>
            ...
            <div class="col-sm-12" style="background-color: rgb(188, 255, 255);overflow:hidden;">
                <h4>Showing other possible [MATCHES] in the following [WTB CITIES] for Supplier Hotel: <?php echo $SupplierHotels['SupplierHotel']['hotel_name'];?></h4>
            </div>
