...
<div class="dwrapper">
 ...
 -->
   ...
   <div class="row">
        ...
        <?php
        echo $this->Html->link('<h4>By Role<span class="pull-right"></span></h4>', '/my-permissions/by-roles', array('data-toggle' => 'tooltip', 'data-placement' => 'right', 'title' => 'My Roles', 'escape' => false));
        ?>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 active">
                ...
                <div class="info-box  bg-info  text-white" id="initial-tour">
                    ...
                    <div class="info-details">
        <?php
        echo $this->Html->link('<h4>By Controller<span class="pull-right"></span></h4>', '/my-permissions/by-controller', array('data-toggle' => 'tooltip', 'data-placement' => 'right', 'title' => 'My Roles', 'escape' => false));
        ?>
                    </div>
                </div>
            </div>
