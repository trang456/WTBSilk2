                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="checkbox one-column">
                                                            ...
                                                            <div>
                                                                ...
                                                                <div class="col-sm-1">
                                                                    <input type="textbox" size="15" max="10" min="0" onchange="handleChange(this);" placeholder="0.0" id="TravelHotelReviewItemReviewScore" value="<?php echo $value_review_score ?>" class="form-control" name="data[TravelHotelReviewItem][review_score][]">
                                                                </div>
																</span>
                                                            </div> 
                                                            <div>
																...
																<span vertical-align: "middle">
                                                                <div class="col-sm-1">
                                                                    <input type="textbox" size="15" min="0" placeholder="0" id="TravelHotelReviewItemNoOfReviews" value="<?php echo $value_no_of_reviews ?>" class="form-control" name="data[TravelHotelReviewItem][no_of_reviews][]">
                                                                </div>
																</span>
                                                            </div>                                                          
                                                        </div>
