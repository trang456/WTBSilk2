<?php
$this->Html->addCrumb('View Hotel', 'javascript:void(0);', array('class' => 'breadcrumblast'));
 $userId = $this->Session->read('Auth.User.id');
 $specialStaticEditPermison = ($userId == 208) ? true : false;
 if($specialStaticEditPermison) { ?>
...
<div class="col-sm-12" id="mycl-det">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <fieldset>
                <legend><span>View Hotel</span></legend>
            </fieldset>
            <div class="row">
                <div class="col-sm-12">
                    <?php
...
<?php
// $imgPath  = "http://www.imageius.com/uploads/hotels/";
$imgPath  = "http://pxh001.ultrafare.host/hotels/";
$imgPath .= strtolower(trim($this->request->data['TravelHotelLookup']['country_name'])).'/';
$imgPath .= strtolower(trim($this->request->data['TravelHotelLookup']['city_name'])).'/';
$imgPath .= strtolower(trim($this->request->data['TravelHotelLookup']['hotel_code'])).'/';
                                            ...
                                            <div class="col-sm-12 editable txtbox">
                                                ...
                                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                                    <div class="fileupload-new img-thumbnail" style="width:400px;height:300px">
                                                        <?php
                                                        $image1DefaultStatus = false;
                                                        if ($this->data['TravelHotelLookup']['full_img1'] !='') {                       
                                                          $image1DefaultStatus = true;                              
                                                            $image1 = $this->data['TravelHotelLookup']['full_img1'];
                                                        } else {
                                                            $image1 = $this->webroot . "img/no_img_180.png";
                                                        }
                                                        ?>
                                                        <img  class= "image1" src="<?php echo $imgPath.$image1?>" height="300" width="400" />
                                                    </div>
                                                    <?php if($specialStaticEditPermison) { ?>
                                                        <div class="fileupload-preview fileupload-exists img-thumbnail" style="width: 400px; height:300px"></div>
                                                    <div>
                                                        <input type="checkbox" name="data[TravelHotelLookup][image1][status]" id="image1Status">
                                                        <span>
                                                             <span class="btn btn-default changeFile" onClick = "changeFile(this)">Change</span>
                                                            <input type="file" name="data[TravelHotelLookup][image1]" id="image1" data-require="true" style="display: none" onchange="loadFile(event)"/>
                                                        </span>
                                                       <!-- <span class="btn btn-danger" data-removeId="image1" onclick="removeImage(this)">Remove</span> -->
                                            ...
                                            <div class="col-sm-12 editable txtbox">
                                                ...
                                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                                    <div class="fileupload-new img-thumbnail" style="width:400px;height:300px">
                                                        ...
                                                        ?>
                                                        <img src="<?php echo $imgPath.$image3?>" height="300" width="400" />

                                                    </div>
                                                    <?php if($specialStaticEditPermison) { ?>
                                                        <div class="fileupload-preview fileupload-exists img-thumbnail" style="width: 400px; height:300px"></div>
                                                    <div>
                                                        <input type="checkbox" name="data[TravelHotelLookup][image3][status]">
                                                        <span>
                                                             <span class="btn btn-default changeFile" onClick = "changeFile(this)">Change</span>
                                                            <input type="file" name="data[TravelHotelLookup][image3]" id="image1" data-require="true" style="display: none" onchange="loadFile(event)"/>
                                                        </span>
                                                       <a href="javascript:void(0)" class="btn btn-danger" data-dismiss="fileupload">Remove</a>
                                                    </div>
                                            ...
                                            <div class="col-sm-12 editable txtbox">
                                                ...
                                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                                    <div class="fileupload-new img-thumbnail" style="width:400px;height:300px">
                                                        ...
                                                        ?>
                                                        <img src="<?php echo $imgPath.$image5?>" height="300" width="400" />

                                                    </div>
                                                    <?php if($specialStaticEditPermison) { ?>
                                                        <div class="fileupload-preview fileupload-exists img-thumbnail" style="width: 400px; height:300px"></div>
                                                    <div>
                                                        <input type="checkbox" name="data[TravelHotelLookup][image5][status]">
                                                        <span>
                                                             <span class="btn btn-default changeFile" onClick = "changeFile(this)">Change</span>
                                                            <input type="file" name="data[TravelHotelLookup][image5]" id="image1" data-require="true" style="display: none" onchange="loadFile(event)"/>
                                                        </span>
                                                        <a href="javascript:void(0)" class="btn btn-danger" data-dismiss="fileupload">Remove</a>
                                                    </div>
                                            ...
                                            <div class="col-sm-12 editable txtbox">
                                                ...
                                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                                    <div class="fileupload-new img-thumbnail" style="width:400px;height:300px">
															...
															?>
                                                        <img src="<?php echo $imgPath.$image2?>" height="300" width="400" />
                                                  
                                                </div>
                                                <?php if($specialStaticEditPermison) { ?>
                                                        <div class="fileupload-preview fileupload-exists img-thumbnail" style="width: 400px; height:300px;"></div>
                                                    <div>
                                                        <input type="checkbox" name="data[TravelHotelLookup][image2][status]">
                                                        <span>
                                                             <span class="btn btn-default changeFile" onClick = "changeFile(this)">Change</span>
                                                            <input type="file" name="data[TravelHotelLookup][image2]" id="image2" data-require="true" style="display: none" onchange="loadFile(event)"/>
                                                        </span>
                                                       <a href="javascript:void(0)" class="btn btn-danger" data-dismiss="fileupload">Remove</a>
                                                    </div>
                                            ...
                                            <div class="col-sm-12 editable txtbox">
                                                ...
                                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                                    <div class="fileupload-new img-thumbnail" style="width:400px;height:300px">
                                                        ...
                                                        ?>
                                                        <img src="<?php echo $imgPath.$image4?>" height="300" width="400" />
                                                    ...
                                                    <div>
                                                        <input type="checkbox" name="data[TravelHotelLookup][image4][status]">
                                                        <span>
                                                             <span class="btn btn-default changeFile" onClick = "changeFile(this)">Change</span>
                                                            <input type="file" name="data[TravelHotelLookup][image4]" id="image4" data-require="true" style="display: none" onchange="loadFile(event)"/>
                                                        </span>
                                                       <a href="javascript:void(0)" class="btn btn-danger" data-dismiss="fileupload">Remove</a>
                                                    </div>
                                            ...
                                            <div class="col-sm-12 editable txtbox">
                                                ...
                                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                                    <div class="fileupload-new img-thumbnail" style="width:400px;height:300px">
                                                        ...
                                                        ?>
                                                        <img src="<?php echo $imgPath.$image6?>"  height="300" width="400" />

                                                    </div>
                                                    <?php if($specialStaticEditPermison) { ?>
                                                    <div class="fileupload-preview fileupload-exists img-thumbnail" style="width: 400px; height:300px;"></div>
                                                    <div>
                                                        <input type="checkbox" name="data[TravelHotelLookup][image6][status]">
                                                        <span>
                                                             <span class="btn btn-default changeFile" onClick = "changeFile(this)">Change</span>
                                                            <input type="file" name="data[TravelHotelLookup][image6]" id="image6" data-require="true" style="display: none" onchange="loadFile(event)"/>
                                                        </span>
                                                       <a href="javascript:void(0)" class="btn btn-danger" data-dismiss="fileupload">Remove</a>
                                                    </div>
                                            ...
                                            <div class="col-sm-12 editable txtbox">
                                                ...
                                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                                    <div class="fileupload-new img-thumbnail" style="width:400px;height:300px">
														...
														if($check === true){
                                                        ?>													
                                                        <img src="<?php echo $imgPath.$image?>"  height="300" width="400" />
														<?php 
														} else{
														?>
                                                    ...
                                                    <div class="fileupload-preview fileupload-exists img-thumbnail" style="width: 400px; height:300px;"></div>
                                                    <div>
                                                        <input type="checkbox" name="data[TravelHotelLookup][image<?= $x?>][status]">
                                                        <span>
                                                             <span class="btn btn-default changeFile" onClick = "changeFile(this)">Change</span>
                                                            <input type="file" name="data[TravelHotelLookup][image<?= $x ?>]" id="image<?= $x ?>" data-require="true" style="display: none" onchange="loadFile(event)"/>
                                                        </span>
                                                      <!--  <span class="btn btn-danger" data-removeId="image<?= $x ?>" onclick="removeImage(this)">Remove</span> -->
                                                      <a href="javascript:void(0)" class="btn btn-danger" data-dismiss="fileupload">Remove</a>
                                                    </div>
...
<script>
   ...
   /*$(document).on('click','span.changeFile',function() {
        alert("hiii");
   });*/
     ...
     function imageValidate(){
       ...
       if (($('#image1').get(0).files.length === 0) && ($("#image1Status").is(":checked")) ) {
   ...
   function changeFile(element) {
     $(element).next('input[type="file"]').click();
   }
   // function to remove image file
   function removeImage(element) {
        var removeId = $(element).attr('data-removeId');
       // alert(removeId);
        $("#"+removeId).trigger('change').val('');
        $("."+removeId).trigger('change').attr('src','');
        $("."+removeId).load();
