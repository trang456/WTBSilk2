...
echo $this->Form->hidden('Common2.wtb_passed_continent_id',array('value' => $wtb_passed_continent_id));
echo $this->Form->hidden('Common2.wtb_passed_country_id',array('value' => $wtb_passed_country_id));
echo $this->Form->hidden('Common2.wtb_passed_province_id',array('value' => $wtb_passed_province_id));
echo $this->Form->hidden('Common2.wtb_passed_city_id',array('value' => $wtb_passed_city_id));
