...
<div class="pop-outer">
    <div class="pop-up-hdng">Mapping Information [WTB HOTEL: <?php echo $hotel_id; ?>]</div>
    <div class="col-sm-12">
                ...
                <tbody>
                    ...
                    if (isset($TravelHotelRoomSuppliers) && count($TravelHotelRoomSuppliers) > 0):
                        foreach ($TravelHotelRoomSuppliers as $TravelHotelRoomSupplier):
                            ...
                            $hotel_address = $this->Custom->getHotalAddress($hotel_id);                            
                            ...
                            <tr>
                                ...
                                <td><?php echo "ID : ".$TravelHotelRoomSupplier['TravelHotelRoomSupplier']['id']."<br>". $TravelHotelRoomSupplier['TravelHotelRoomSupplier']['supplier_code']."<br>".$status_txt."<br>". "ACTIVE : ".$TravelHotelRoomSupplier['TravelHotelRoomSupplier']['active']."<br>". "EXCLUDED : ".$TravelHotelRoomSupplier['TravelHotelRoomSupplier']['excluded']."<br>". "CREATED BY : "."<br>".$this->Custom->Username($TravelHotelRoomSupplier['TravelHotelRoomSupplier']['created_by'])."<br>". "APPROVED BY : "."<br>".$this->Custom->Username($TravelHotelRoomSupplier['TravelHotelRoomSupplier']['approved_by'])."<br>". "CREATED ON : ".$TravelHotelRoomSupplier['TravelHotelRoomSupplier']['created']."<br>". "APPROVED ON : ".$TravelHotelRoomSupplier['TravelHotelRoomSupplier']['approved_date']."<br>". "MODIFIED ON : ".$TravelHotelRoomSupplier['TravelHotelRoomSupplier']['modified']; ?></td>
