...
<nav id="sidebar">
 ...
 elseif ($this->Session->read('role_id') == '64') {
  ...
  elseif ($this->Session->read('role_id') == '61' || $this->Session->read('role_id') == '62') {
     ?>
            <li <?php if ($cur_page == 'reports') { ?> class="active"<?php } ?>>  
                <?php
                echo $this->Html->link('<i class="icon-tasks"></i><span>My Reports</span>', '/admin/reports', array('data-toggle' => 'tooltip', 'data-placement' => 'right', 'title' => 'My Reports', 'escape' => false));
  ...
  elseif ($this->Session->read('role_id') == '70') {
     ?>
            <li <?php if ($cur_page == 'travel_hotel_reviews') { ?> class="active"<?php } ?>>  
                <?php
                echo $this->Html->link('<i class="icon-tasks"></i><span>My Hotel Reviews</span>', '/travel_hotel_reviews/', array('data-toggle' => 'tooltip', 'data-placement' => 'right', 'title' => 'My Hotel Reviews', 'escape' => false));
                ?>           
            </li>
            <li <?php if ($cur_page == 'data') { ?> class="active"<?php } ?>>  
                <?php
                echo $this->Html->link('<i class="icon-tasks"></i><span>Admin</span>', '/admin/data', array('data-toggle' => 'tooltip', 'data-placement' => 'right', 'title' => 'My Data', 'escape' => false));
                ?>           
            </li> 
            <li <?php if ($cur_page == 'reports') { ?> class="active"<?php } ?>>  
                <?php
 ...
 elseif ($this->Session->read('role_id') == '66') {
  ...
  elseif ($this->Session->read('role_id') == '44') {
     ?>
            <li <?php if ($cur_page == 'to-come') { ?> class="active"<?php } ?>>  
                <?php
                echo $this->Html->link('<i class="icon-tasks"></i><span>Log Area</span>', '/log_calls/', array('data-toggle' => 'tooltip', 'data-placement' => 'right', 'title' => 'Log Area', 'escape' => false));
                ?>           
            </li>
            <li <?php if ($cur_page == 'to-come') { ?> class="active"<?php } ?>>  
                <?php
                echo $this->Html->link('<i class="icon-tasks"></i><span>WTB Error Area</span>', '/travel_wtb_errors/', array('data-toggle' => 'tooltip', 'data-placement' => 'right', 'title' => 'WTB Error Area', 'escape' => false));
                ?>           
            </li>            
            <li <?php if ($cur_page == 'download_tables/download_ota/') { ?> class="active"<?php } ?>>  
                <?php
                echo $this->Html->link('<i class="icon-tasks"></i><span>DB Area</span>', '/db-area/', array('data-toggle' => 'tooltip', 'data-placement' => 'right', 'title' => 'DB Area', 'escape' => false));
                ?>           
            </li>
            <li <?php if ($cur_page == 'travel_hotel_images/') { ?> class="active"<?php } ?>>  
                <?php
                echo $this->Html->link('<i class="icon-tasks"></i><span>XML Test Area</span>', '/xml_tests/', array('data-toggle' => 'tooltip', 'data-placement' => 'right', 'title' => 'XML Test Area', 'escape' => false));
                ?>           
            </li>            
            <?php
 }
