...
<div class="col-md-4 active">
                <div class="info-box  bg-info  text-white" id="initial-tour">
                    ...
                    <div class="info-details">
        <?php
        echo $this->Html->link('<h4>My Hotel Reviews<span class="pull-right"></span></h4>', '/travel_hotel_reviews', array('data-toggle' => 'tooltip', 'data-placement' => 'right', 'title' => 'Reports', 'escape' => false));
        ?>
                    </div>
                </div>
            </div>
        ...
        ?>
            ...
            <div class="col-md-4 active">
                ...
                <div class="info-box  bg-info  text-white" id="initial-tour">
                    ...
                    <div class="info-details">
        <?php
        echo $this->Html->link('<h4>Operations<span class="pull-right"></span></h4>', '/mass_operations', array('data-toggle' => 'tooltip', 'data-placement' => 'right', 'title' => 'Operation', 'escape' => false));
        ?>
                    </div>
                </div>
            </div>
...
<div class="info-box  bg-info  text-white" id="initial-tour">
    ...
    <div class="info-details">
        <?php echo $this->Html->link('<h4>WTB Error Area<span class="pull-right"></span></h4>', '/travel_wtb_errors/', array('data-toggle' => 'tooltip', 'data-placement' => 'right', 'title' => 'WTB Error Area', 'escape' => false));
?>
    </div>
</div>
</div>
...
?>
	...
	elseif($this->Session->read('role_id') == '68' || $this->Session->read('role_id') == '28'){
			?>
			<div class="row">
			<div class="col-md-4 active">
                <div class="info-box  bg-info  text-white" id="initial-tour">
        ...
        <div class="row">
            <div class="col-md-4 active">
                ...
                <div class="info-box  bg-info  text-white" id="initial-tour">
                    ...
                    <div class="info-details">
        <?php
        echo $this->Html->link('<h4>My Hotel Reviews<span class="pull-right"></span></h4>', '/travel_hotel_reviews/', array('data-toggle' => 'tooltip', 'data-placement' => 'right', 'title' => 'My Hotel Reviews', 'escape' => false));
        ?>
                    </div>
                </div>
            ...
            <div class="col-md-4 active">
                ...
                <div class="info-box  bg-info  text-white" id="initial-tour">
                    ...
                    <div class="info-details">
        <?php
        echo $this->Html->link('<h4>My Data<span class="pull-right"></span></h4>', '/admin/data', array('data-toggle' => 'tooltip', 'data-placement' => 'right', 'title' => 'My Data', 'escape' => false));
        ?>
                    </div>
                </div>
            </div>
