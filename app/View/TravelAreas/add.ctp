            ...
            <div class="row">
                <div class="col-sm-12">
                       ...
                       <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10"><?php
                                echo $this->Form->input('top_area', array('options' => array('TRUE' => 'TRUE','FALSE' => 'FALSE'),'empty' => '--Select--'));
                                ?></div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <?php
                            echo $this->Form->input('area_description', array('type' => 'textarea','style' => 'width:122%;height:100px'));
                            ?></div>
                    </div>
...
<script>
    ...
    $('#TravelAreaCountryId').change(function(){    
      ...
      var str = $('#TravelAreaCountryId option:selected').text();
            var res = str.split("-");          
            //$('#TravelHotelLookupCountryCode').val(res[0]);
            $('#TravelAreaCountryName').val(res[1]);
    });
