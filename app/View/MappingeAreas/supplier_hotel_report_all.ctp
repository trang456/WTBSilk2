<?php
$this->Html->addCrumb('My Supplier Hotel Report All', 'javascript:void(0);', array('class' => 'breadcrumblast'));
    ...
    <div class="col-sm-12">
        ...
        <div class="panel panel-default">
            ...
            <div class="col-sm-12" style="background-color: rgb(188, 255, 255);overflow:hidden;padding: 15px">
                <h4>Showing [ALL] [SUPPLIER HOTELS] from Following [<?php echo $this->Custom->getSupplierCode($supplier_id);?>] Cities:</h4>
                               ...
                               // echo count($SupplierHotel['TravelHotelRoomSupplier']);?></td>
                                ...
                                <td valign="middle" align="center">
                                    ...
                                    if($SupplierHotel['SupplierHotel']['status'] == '1' || $SupplierHotel['SupplierHotel']['status'] == '5')
                                        echo $this->Html->link('<span class="icon-list"></span>', array('controller' => 'admin', 'action' => 'hotel_mapping/' . $id.'/'.$SupplierHotel['SupplierHotel']['supplier_id'].'/'.$SupplierHotel['SupplierHotel']['country_code'].'/'.$SupplierHotel['SupplierHotel']['city_id']), array('class' => 'act-ico','target' => '_blank', 'escape' => false));
                                    }
                                    ?>
                                </td>
