<?php
$this->Html->addCrumb('My Supplier Hotel Report', 'javascript:void(0);', array('class' => 'breadcrumblast'));
    ...
    <div class="col-sm-12">
        ...
        <div class="panel panel-default">
            ...
            <div class="col-sm-12" style="background-color: rgb(188, 255, 255);overflow:hidden;padding: 15px">
                <h4>Showing [UNMAPPED] [SUPPLIER HOTELS] from Following [<?php echo $this->Custom->getSupplierCode($supplier_id);?>] Cities:</h4>
             <table border="0" cellpadding="0" cellspacing="0" id="resp_table" class="table toggle-square myclitb" data-filter="#table_search" data-page-size="500">
                ...
                <tbody>
                    ...
                    $wtb_continent_id = $continent_id;
                    $wtb_country_id = $country_id;
                    $wtb_province_id = $province_id;
                    $wtb_city_id = $city_id;                    
